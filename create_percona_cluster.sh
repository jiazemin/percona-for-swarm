...
-e "6INTROSPECT_STATUS_LONG=wsrep_received_bytes" \
-e "7INTROSPECT_STATUS_LONG=wsrep_replicated_bytes" \
-e "8INTROSPECT_STATUS_LONG=wsrep_flow_control_recv" \
-e "9INTROSPECT_STATUS_LONG=wsrep_flow_control_sent" \
-e "10INTROSPECT_STATUS_LONG=wsrep_flow_control_paused_ns" \
-e "11INTROSPECT_STATUS_LONG=wsrep_local_commits" \
-e "12INTROSPECT_STATUS_LONG=wsrep_local_bf_aborts" \
-e "13INTROSPECT_STATUS_LONG=wsrep_local_cert_failures" \
